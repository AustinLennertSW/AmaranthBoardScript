...
(function() {
    ...
    /** Wraps a function in a common try catch */
    function safeWrap(fn) {
        return function() {
            try {
                return fn.apply(this, arguments);
            } catch (error) {
                console.error(`CUSTOM SCRIPT: There was a problem when running the '${fn.name}' script:`);
                console.error(error);
            }
        }
    }
    ...
    displayPointValues = safeWrap(displayPointValues);
    ...
    enlargeGoalModal = safeWrap(enlargeGoalModal);
    ...
    setAssignedData = safeWrap(setAssignedData);
    ...
    autoMarkPatch = safeWrap(autoMarkPatch);
    ...
    hideUnnecessaryActionDescriptions = safeWrap(hideUnnecessaryActionDescriptions);
    ...
    addSignalRMethodLogs = safeWrap(addSignalRMethodLogs);
    ...
    addOpenProjectFromClipboardButton = safeWrap(addOpenProjectFromClipboardButton);
...
.ProgressBar {
    ...
    removeTimeEstimates = safeWrap(removeTimeEstimates);
...
html { ${devColors} }
    ...
    addCustomStyles = safeWrap(addCustomStyles);
